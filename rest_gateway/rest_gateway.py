...
AUTH_GRPC = os.getenv('AUTH_GRPC_HOST', 'auth_service:50051')  # auth_service is fine via service name
COURSE_GRPC = os.getenv('COURSE_GRPC_HOST', 'course_service:50052')
ENROLLMENT_GRPC = os.getenv('ENROLLMENT_GRPC_HOST', 'enrollment_service:50053')
GRADES_GRPC = os.getenv('GRADES_GRPC_HOST', 'grades_service:50054')
FACULTY_GRADES_GRPC = os.getenv('FACULTY_GRADES_GRPC_HOST', 'faculty_grades_service:50055')
...
@app.route('/api/v1/enroll/student', methods=['GET'])
...
@app.route('/api/v1/enroll/drop/<course_id>', methods=['DELETE'])
